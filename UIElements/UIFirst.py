...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.userMessageDisplay.setWordWrap(True)
        # self.userMessageDisplay.setAutoScroll(True)
        # self.userMessageDisplay.setUniformRowHeights(False)
        # scroll_bar = QScrollBar(self.userMessageDisplay)
        # self.userMessageDisplay.setHorizontalScrollBar(scroll_bar)
        # self.userMessageDisplay.setHorizontalScrollMode(QTScrollMode)
        ...
        self.scannerPage = QtWidgets.QWidget()
        self.scannerPage.setObjectName("scannerPage")
        self.tabWidget.addTab(self.scannerPage, "Scanners")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.userMessageDisplay.headerItem().setText(0, _translate("MainWindow", "TIME"))
        self.userMessageDisplay.headerItem().setText(1, _translate("MainWindow", "TYPE"))
        self.userMessageDisplay.headerItem().setText(2, _translate("MainWindow", "P_ID"))
        self.userMessageDisplay.headerItem().setText(3, _translate("MainWindow", "MESSAGE"))
        self.brokerMessageDisplay.setTabText(self.brokerMessageDisplay.indexOf(self.tab), _translate("MainWindow", "System Messages"))
        self.brokerMessagesDisplay.headerItem().setText(0, _translate("MainWindow", "TIME"))
        self.brokerMessagesDisplay.headerItem().setText(1, _translate("MainWindow", "TYPE"))
