...
#         self.tabWidget.addTab(self.scannerPage, "")
...
#         self.brokerInformation.setCurrentIndex(0)
...
#         self.tabWidget.setTabText(self.tabWidget.indexOf(self.scannerPage), _translate("MainWindow", "Scanners"))
